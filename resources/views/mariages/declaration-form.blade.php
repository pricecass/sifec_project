...
<div class="wrapper" style="background-color: white;">
    <div class="container-fluid">
                    ...
                    <li>
                        <div class="input-group-btn">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                <li><a href="#" class="dropdown-item">
                                        <i class="ti-trash"></i>&nbsp;&nbsp;Supprimer</a>
                                </li>

                                <li><a href="#" class="dropdown-item" target="_blank">
                                        <span style="font-size: 16px"><i class="mdi mdi-file-pdf"></i></span>&nbsp;&nbsp;Imprimer la publication</a>
                                </li>


                                <li><a href="#" class="dropdown-item" data-toggle="modal" data-target=".bs-example-modal-lg">
                                        <i class="ti-plus"></i>&nbsp;&nbsp;Ajouter une déclaration</a>
                                </li>
        ...
        @elseif(session()->has('alert_mariage1'))
            <div class="row">
                <div class="col-sm-8 offset-sm-2">
                    <div class="alert alert-icon alert-danger alert-dismissible fade show" role="alert">
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        ...
                        <i class="mdi mdi-block-helper"></i>
                        <strong>Echec d'enregistrement ! </strong>{{ session('alert_mariage1') }}
                    </div>
                </div>
            </div>
        @elseif(session()->has('alert_mariage2'))
            <div class="row">
                <div class="col-sm-8 offset-sm-2">
                    <div class="alert alert-icon alert-danger alert-dismissible fade show" role="alert">
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        ...
                        <i class="mdi mdi-block-helper"></i>
                        <strong>Echec d'enregistrement ! </strong>{{ session('alert_mariage2') }}
                    </div>
                </div>
            </div>
        @endif
            ...
            <div class="col-sm-12">
                ...
                <form class="form-horizontal" method="post" action="{{ route('declaration.save') }}">
                    ...
                    <div class="tab-content" style="">
                        ...
                        <input type="text" name="centre_id" value="{{ $etatcivil->id }}" hidden>
                        ...
                        <div class="tab-pane fade show active" id="epoux_id">
                                ...
                                <div class="col-sm-3 text-lg-left end">
                                    <div class="input-group">
                                        <input type="text" name="date_naiss_epoux" placeholder="jj/mm/aaaa" id="datepicker-autoclose1"
                                               ...
                                               value="{{ old('date_naiss_epoux') }}" @if(session()->has('success') ) disabled @endif
                                               onchange="checkAgeEpoux(this);">
                                    ...
                                    <span id="msgAge1" style="color: #e50000; display: none"><i class="mdi mdi-alert mdi-24px"></i>
                                        &nbsp;Cette date de naissance ne donne pas l'âge réquis pour contracter un mariage. Veuillez choisir une autre date svp.
                                    </span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3 text-lg-left end">
                                    <input type="text" name="lieu_naiss_epoux"
                                           ...
                                           value="{{ old('lieu_naiss_epoux') }}" @if(session()->has('success') ) readonly @endif >
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2 text-lg-left end">
                                    <input type="number" min="1" name="acte_naiss_epoux"
                                           ...
                                           value="{{ old('acte_naiss_epoux') }}" @if(session()->has('success') ) readonly @endif>
                                ...
                                <div class="col-sm-3 text-sm-left">
                                    <div class="input-group">
                                        <input type="text" name="date_delivrance_acte_naiss_epoux" placeholder="jj/mm/aaaa" id="datepicker-autoclose2"
                                               ...
                                               value="{{ old('date_delivrance_acte_naiss_epoux') }}" @if(session()->has('success') ) disabled @endif
                                               onchange="comparDate1();">
                                        <span class="input-group-addon bg-success b-0"><i class="mdi mdi-calendar text-white"></i></span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3 text-lg-left end">
                                    <input type="text" name="profession_epoux" class="form-control {{ $errors->has('profession_epoux') ? 'is-invalid' : '' }}"
                                           value="{{ old('profession_epoux') }}" @if(session()->has('success') ) readonly @endif >
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-lg-left end">
                                    <input type="text" name="adresse_epoux" class="form-control {{ $errors->has('adresse_epoux') ? 'is-invalid' : '' }}"
                                            value="{{ old('adresse_epoux') }}" @if(session()->has('success') ) readonly @endif >
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-lg-left end">
                                    <input type="text" name="parent1_epoux" class="form-control {{ $errors->has('parent1_epoux') ? 'is-invalid' : '' }}"
                                        value="{{ old('parent1_epoux') }}" @if(session()->has('success') ) readonly @endif >
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-lg-left end">
                                        ...
                                        value="{{ old('parent2_epoux') }}" @if(session()->has('success') ) readonly @endif >
                                ...
                                <div class="col-sm-3 text-lg-left end">
                                    <div class="input-group">
                                        <input type="text" name="date_naiss_epouse" placeholder="jj/mm/aaaa" id="datepicker-autoclose3"
                                               ...
                                               value="{{ old('date_naiss_epouse') }}" @if(session()->has('success') ) disabled @endif
                                               onchange="checkAgeEpouse(this)">

                                        <span class="input-group-addon bg-success b-0"><i class="mdi mdi-calendar text-white"></i></span>
                                        {{--{!! $errors->first('date_naiss_epouse', '<div class="invalid-feedback">:message</div>') !!}--}}
                                    </div>
                                    <span id="msgAge2" style="color: #e50000; display: none"><i class="mdi mdi-alert mdi-24px"></i>
                                        &nbsp;Cette date de naissance ne donne pas l'âge réquis pour contracter un mariage. Veuillez choisir une autre date svp.
                                    </span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3 text-lg-left end">
                                    <input type="text" name="lieu_naiss_epouse"
                                           ...
                                           value="{{ old('lieu_naiss_epouse') }}" @if(session()->has('success') ) readonly @endif >
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2 text-lg-left end">
                                    <input type="number" min="1" name="acte_naiss_epouse"
                                           ...
                                           value="{{ old('acte_naiss_epouse') }}" @if(session()->has('success') ) readonly @endif>
                                ...
                                <div class="col-sm-3 text-sm-left">
                                    <div class="input-group">
                                        <input type="text" name="date_delivrance_acte_naiss_epouse" placeholder="jj/mm/aaaa" id="datepicker-autoclose4"
                                               ...
                                               value="{{ old('date_delivrance_acte_naiss_epouse') }}" @if(session()->has('success') ) disabled @endif
                                               onchange="comparDate2();">
                                        <span class="input-group-addon bg-success b-0"><i class="mdi mdi-calendar text-white"></i></span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3 text-lg-left end">
                                    <input type="text" name="profession_epouse" class="form-control {{ $errors->has('profession_epouse') ? 'is-invalid' : '' }}"
                                           value="{{ old('profession_epouse') }}" @if(session()->has('success') ) readonly @endif >
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-lg-left end">
                                    <select name="situation_matrimoniale_epouse"
                                        ...
                                        <option value="">---</option>
                                        <option value="Pré-marié">Pré-marié</option>
                                        <option value="en concubinage">Célibataire</option>
                                        <option value="en concubinage">Divorcée</option>
                                        <option value="en concubinage">Veuve</option>
                                    </select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-lg-left end">
                                    <input type="text" name="adresse_epouse" class="form-control {{ $errors->has('adresse_epouse') ? 'is-invalid' : '' }}"
                                           value="{{ old('adresse_epouse') }}" @if(session()->has('success') ) readonly @endif >
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-lg-left end">
                                    <input type="text" name="parent1_epouse" class="form-control {{ $errors->has('parent1_epouse') ? 'is-invalid' : '' }}"
                                           value="{{ old('parent1_epouse') }}" @if(session()->has('success') ) readonly @endif >
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-lg-left end">
                                    <input type="text" name="parent2_epouse" class="form-control {{ $errors->has('parent2_epouse') ? 'is-invalid' : '' }}"
                                           value="{{ old('parent2_epouse') }}" @if(session()->has('success') ) readonly @endif >
                        ...
                        <div class="tab-pane fade" id="temoins_epoux_id">
                            ...
                            <div class="row">
                                <div class="checkbox checkbox-success form-check-inline col-sm-6 offset-lg-3">
                                    <input type="checkbox" id="checkID"  name="fil" onclick="infoActeTemoins(this, infoAct1)">
                                    Cocher cette case pour un mariage contracté à l'étranger.
                                </div>
                            ...
                            <div id="infoAct1">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 text-lg-left">
                                        <input type="number" min="1" name="numero_acte_temoins_epoux"
                                               class="form-control {{ $errors->has('numero_acte_temoins_epoux') ? 'is-invalid' : '' }}"
                                               value="{{ old('numero_acte_temoins_epoux') }}"
                                               @if(session()->has('success')) readonly @endif
                                               @if(session()->has('alert_mariage1')) style="border: #e50000 solid 1px;" @endif >

                                        @if(session()->has('alert_mariage1'))
                                            <span style="color: #e50000;"><i class="mdi mdi-alert mdi-24px"></i>&nbsp;Acte de mariage érroné.</span>
                                        @endif

                                        {!! $errors->first('numero_acte_temoins_epoux', '<div class="invalid-feedback">:message</div>') !!}
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 text-lg-left">
                                        <input type="text" name="reference_reg_acte_temoins_epoux"
                                               class="form-control {{ $errors->has('reference_reg_acte_temoins_epouse') ? 'is-invalid' : '' }}"
                                               value="{{ old('reference_reg_acte_temoins_epoux') }}"
                                               @if(session()->has('success') ) readonly @endif >

                                        {!! $errors->first('reference_reg_acte_temoins_epouse', '<div class="invalid-feedback">:message</div>') !!}
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 text-lg-left">
                                        <select name="lieu_delivrance_acte_mariage_temoins_epoux" onchange="getLieu(this);"
                                                class="form-control select2 {{ $errors->has('lieu_delivrance_acte_mariage_temoins_epoux') ? 'is-invalid' : '' }}">
                                            <option value="">---</option>
                                            ...
                                            @foreach($allCentres as $centre)
                                                <option value="{{ $centre->designation }}"
                                                    ...
                                                    {{ $centre->designation }} - {{ $centre->department }}
                                                </option>
                                            @endforeach

                                        </select>

                                        {!! $errors->first('lieu_delivrance_acte_mariage_temoins_epoux', '<div class="invalid-feedback">:message</div>') !!}
                                    </div>
                                    ...
                                    <div class="col-sm-1 text-lg-left">
                                        ...
                                        {!! $errors->first('annee_delivrance_acte_mariage_temoins_epoux', '<div class="invalid-feedback">:message</div>') !!}
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-lg-left end">
                                    <input type="text" name="nom_temoin1_epoux"
                                           ...
                                           value="{{ old('nom_temoin1_epoux') }}" @if(session()->has('success') ) readonly @endif >
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-lg-left end">
                                    <input type="text" name="prenom_temoin1_epoux"
                                           ...
                                           value="{{ old('prenom_temoin1_epoux') }}" @if(session()->has('success') ) readonly @endif >
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-lg-left end">
                                    <input type="text" name="profession_temoin1_epoux"
                                           ...
                                           value="{{ old('profession_temoin1_epoux') }}" @if(session()->has('success') ) readonly @endif >
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-lg-left end">
                                    <input type="text" name="domicile_temoin1_epoux"
                                           ...
                                           value="{{ old('domicile_temoin1_epoux') }}" @if(session()->has('success') ) readonly @endif >
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-lg-left end">
                                    <input type="text" name="nom_jeune_fille_temoin2_epoux"
                                           ...
                                           value="{{ old('nom_jeune_fille_temoin2_epoux') }}" @if(session()->has('success') ) readonly @endif >
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-lg-left end">
                                    <input type="text" name="profession_temoin2_epoux"
                                           ...
                                           value="{{ old('profession_temoin2_epoux') }}" @if(session()->has('success') ) readonly @endif >
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-lg-left end">
                                    <input type="text" name="domicile_temoin2_epoux"
                                           ...
                                           value="{{ old('domicile_temoin2_epoux') }}" @if(session()->has('success') ) readonly @endif >
                        ...
                        <div class="tab-pane fade" id="temoins_epouse_id">
                            ...
                            <div id="infoAct2">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 text-lg-left">
                                        <input type="number" min="1" name="numero_acte_temoins_epouse"
                                               class="form-control {{ $errors->has('numero_acte_temoins_epouse') ? 'is-invalid' : '' }}"
                                               value="{{ old('numero_acte_temoins_epouse') }}" @if(session()->has('success') ) readonly @endif >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 text-lg-left">
                                        <input type="text" name="reference_reg_acte_temoins_epouse"
                                               class="form-control {{ $errors->has('reference_reg_acte_temoins_epouse') ? 'is-invalid' : '' }}"
                                               value="{{ old('reference_reg_acte_temoins_epouse') }}"
                                               @if(session()->has('success') ) readonly @endif >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 text-lg-left">
                                        ...
                                        {!! $errors->first('lieu_delivrance_acte_mariage_temoins_epouse', '<div class="invalid-feedback">:message</div>') !!}
                                    </div>
                                    ...
                                    <div class="col-sm-1 text-lg-left">
                                        ...
                                        {!! $errors->first('annee_delivrance_acte_mariage_temoins_epouse', '<div class="invalid-feedback">:message</div>') !!}
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-lg-left end">
                                    <input type="text" name="nom_temoin1_epouse"
                                           ...
                                           value="{{ old('nom_temoin1_epouse') }}" @if(session()->has('success') ) readonly @endif >
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-lg-left end">
                                    <input type="text" name="prenom_temoin1_epouse"
                                           ...
                                           value="{{ old('prenom_temoin1_epouse') }}" @if(session()->has('success') ) readonly @endif >
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-lg-left end">
                                    <input type="text" name="profession_temoin1_epouse"
                                           ...
                                           value="{{ old('profession_temoin1_epouse') }}" @if(session()->has('success') ) readonly @endif >
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-lg-left end">
                                    <input type="text" name="domicile_temoin1_epouse"
                                           ...
                                           value="{{ old('domicile_temoin1_epouse') }}" @if(session()->has('success') ) readonly @endif >
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-lg-left end">
                                    <input type="text" name="nom_jeune_fille_temoin2_epouse"
                                           ...
                                           value="{{ old('nom_jeune_fille_temoin2_epouse') }}" @if(session()->has('success') ) readonly @endif >
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-lg-left end">
                                    <input type="text" name="profession_temoin2_epouse"
                                           ...
                                           value="{{ old('profession_temoin2_epouse') }}" @if(session()->has('success') ) readonly @endif >
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-lg-left end">
                                    <input type="text" name="domicile_temoin2_epouse"
                                           ...
                                           value="{{ old('domicile_temoin2_epouse') }}" @if(session()->has('success') ) readonly @endif >
                        ...
                        <div class="tab-pane fade" id="infoComp_id">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3 text-lg-left end">
                                    <div class="input-group">
                                        <input type="text" name="date_celebration" id="datepicker-autoclose6" placeholder="jj/mm/aaaa"
                                               class="form-control {{ $errors->has('date_celebration') ? 'is-invalid' : '' }}"
                                               value="{{ old('date_celebration') }}"
                                               @if(session()->has('success') ) disabled @endif
                                               onchange="checkDateCelebration(this);" >
                                    ...
                                    <span id="msgDateCel" style="color: #e50000; display: none"><i class="mdi mdi-alert mdi-24px"></i>
                                        &nbsp;Le mariage est célébré 2 mois après sa déclaration.
                                        Veuillez changer la date de célébration svp.
                                    </span>
                                ...
                                <div class="col-sm-4 col-sm-offset-1">
                                    <select name="lieu_celebration"
                                        ...
                                        @endif
                                            ...
                                            <option value="">---</option>
                                        @foreach($etatsCivils_dep as $etatCivil)
                    ...
                    <div class="row">
                        <div class="col-sm-4 offset-lg-4">
                            <button type="submit" class="btn btn-success txtSizeLarge2">Enregistrer&nbsp;<i class="mdi mdi-content-save"></i></button>

                            <button type="reset" class="btn btn-default txtSizeLarge2" onclick="cancelDec();">Annuler&nbsp;<i class="mdi mdi-refresh"></i></button>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <p style="border-left:#d7dfbc solid 0.5px; padding-left: 10px">
                    ...
                    <span class="txtSizeRegular txtColorBlack">&nbsp;{{ $centre->department }}</span><br>
